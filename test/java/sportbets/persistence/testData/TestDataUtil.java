...
public class TestDataUtil {
    ...
    public static Spieltag  testSpieltag = new Spieltag(1, new Date(), testRound);
    public static  Spiel testSpiel1 = new Spiel(testSpieltag, 1, new Date(), team1, team2, 3, 1, false);
    public static Spiel testSpiel2 = new Spiel(testSpieltag, 2, new Date(), team3, team4, 2, 2, false);
