...
public class TestConstants {
    ...
    public static CompetitionFamilyDto TEST_FAMILY = new CompetitionFamilyDto(null, "TEST FAMILY", "description of testliga", true, true, Country.GERMANY);
    public static CompetitionDto TEST_COMP = new CompetitionDto(null, "TestLiga: Saison 2025", "Description of Competition", 3, 1, null, TEST_FAMILY.getName(), 18, 17);
   }
