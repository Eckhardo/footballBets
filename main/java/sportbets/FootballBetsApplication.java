...
//
//            for (Spieltag spieltag : spieltagHin) {
//                TippConfig tippConfig = new TippConfig(spieltag, compMemb, buliModus);
//                configRepo.save(tippConfig);
//            }
//            for (Spieltag spieltag : spieltagRueck) {
//                TippConfig tippConfig = new TippConfig(spieltag, compMemb, buliModus2);
//                configRepo.save(tippConfig);
//            }
//
